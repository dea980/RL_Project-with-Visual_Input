...
class ConvVAE(nn.Module):
    def __init__(self, in_dim, latent_dim, device = "cpu"):
        ...
        # Encoder
        # (1, h, w) -> (8, h/2, w/2) -> (16, h/4, w/4) for grayscale
        self.encoder_1 = nn.Conv2d(1, 8, 3, stride = 2, padding = 1)
        ...
        # Decoder
        # (16, h/4, w/4) -> (8, h/2, w/2) -> (1, h, w) for grayscale
        self.decoder_1 = nn.ConvTranspose2d(16, 8, 4, stride = 2, padding = 1)
        self.decoder_2 = nn.ConvTranspose2d(8, 1, 4, stride = 2, padding = 1)
